...
class ProfileTestClass(TestCase):
    def setup (self):
        self.user= User(username='lugaga',email='maureezgaga@gmail.com', password='notorious')
        self.user.save()
...
class ImageTestClass(TestCase):
    ...
    '/posts',bio='love chocolate',profile_user=self.user,)
        self.profile.save()
        self.image = Image(image='posts/',image_name='testing',image_caption='testing2',pub_date='28/07/2019',image_profile=self.profile,likes=self.profile)
